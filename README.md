...
| -------------------------- |:-----------------------------------------------------------------------------:|:-------------------|-------------------|
| [Picturesque](https://github.com/mbrad26/picf) | Work in progress - Flickr or Instagram type of social media platform | Firebase Auth, Firebase Firestore, Firebase Storage, React, Redux, Redux-Saga | Cypress, Jest, React testing library    |
